...
| [`cpp14/`](cpp14/) | The C++11 clean-up round: generic lambdas, init-captures, relaxed constexpr, make_unique, variable templates, std::exchange, heterogeneous lookup, shared_timed_mutex, standard literals. | Spot-fills between C++11 and C++17. |
