...
One subfolder per standard. Each subfolder has its own auto-generated
`README.md` listing its examples grouped by topic.
...
| [`cpp26/`](cpp26/) | Saturation arithmetic, contracts, static reflection (all flagged `experimental=true`). | Tracking what GCC 14+ has of C++26 already. |
