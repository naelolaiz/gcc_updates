...
| [gccext_inline_asm.cpp](gccext_inline_asm.cpp) | c++17 | 13 | Basic GCC extended inline asm. Demonstrates the input/output operand syntax. x86_64-only; tagged experimental for portability. *(experimental)* |
