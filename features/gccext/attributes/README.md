...
_Folder: `features/gccext/attributes/`. 8 example(s) across 1 topic(s). Auto-generated from each file's `// gcc-test:` header — do not edit by hand. Run `python3 scripts/discover.py --emit-docs` to refresh._
...
| [gccext_attribute_target.cpp](gccext_attribute_target.cpp) | c++17 | 13 | [[gnu::target("avx2")]] compiles ONE function with extra ISA flags; the rest of the TU stays at the default ISA. *(experimental)* |
...
| [gccext_target_clones.cpp](gccext_target_clones.cpp) | c++17 | 13 | [[gnu::target_clones("default,avx2,avx512f")]] generates multiple versions; an IFUNC dispatches to the best at startup. *(experimental)* |
